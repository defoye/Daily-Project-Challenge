...
public class E3TableViewController: UIViewController, TableViewControlling {
	// MARK:- Instance data.
...
extension E3TableViewController {
	// MARK:- Lifecycle
...
extension E3TableViewController: UITableViewDataSource {
...
extension E3TableViewController: UITableViewDelegate {
